...
fileToRewrite = ["SingleMuon","WToLNu_2J","WW","ZZ","WZ","TT","VBF_HToMuMu", "GluGlu_HToMuMu"] + ST_list + DY_list
...
for fileName in fileToRewrite :
    ...
    #for qcd in QCD_varation :
        #for jes in JES_varation :
                ...
                jer = JER_varation[n]
                pu  = PU_varation[n]
                if fileName == "SingleMuon" and qcd != "nom" and jes != "nom" and jer != "nom" and pu != "nom" : continue


                #open the actual tree
                f_tocompute=ROOT.TFile("/scratch/mandorli/Hmumu/restartFromFilippo/CMSSW_8_0_28/src/code/mvaTree/main_tmva_tree_"+fileName+"_v25mu_QCDScale"+qcd+"_JES"+jes+"_JER"+jer+"_PU"+pu+".root")
